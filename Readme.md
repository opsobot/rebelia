...
NOTE: This version will be certified with OSHWA after is stable, at the moment the only version certified with OSHWA is the V1, you can check its branch 'V1' in the repo.
